...
export const Carousel = () => {
	...
	const scrollRight = () => {
		if (ref.current) {
			ref.current.scrollLeft += 500; // Incrementa el desplazamiento horizontal en 500 píxeles.
		}
	};
	...
	const scrollLeft = () => {
		if (ref.current) {
			ref.current.scrollLeft -= 500; // Decrementa el desplazamiento horizontal en 500 píxeles.
		}
	};
